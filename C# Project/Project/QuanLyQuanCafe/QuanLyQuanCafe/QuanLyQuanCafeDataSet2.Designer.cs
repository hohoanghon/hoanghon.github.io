...
namespace QuanLyQuanCafe {
    ...
    public partial class QuanLyQuanCafeDataSet2 : global::System.Data.DataSet {
        ...
        public partial class KhoDataTable : global::System.Data.TypedTableBase<KhoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public KhoRow AddKhoRow(string name, double soluong) {
        ...
        public partial class KhoRow : global::System.Data.DataRow {
            ...
            public string name {
                get {
                    return ((string)(this[this.tableKho.nameColumn]));
                }
                set {
                    this[this.tableKho.nameColumn] = value;
                }
            }
            ...
            public double soluong {
                get {
                    return ((double)(this[this.tableKho.soluongColumn]));
                }
                set {
...
namespace QuanLyQuanCafe.QuanLyQuanCafeDataSet2TableAdapters {
    ...
    public partial class KhoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Kho] WHERE (([id] = @Original_id) AND ([name] = @Original_name" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Kho] ([name], [soluong]) VALUES (@name, @soluong);\r\nSELECT id," +
                " name, soluong FROM Kho WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Kho] SET [name] = @name, [soluong] = @soluong WHERE (([id] = @Origi" +
                "nal_id) AND ([name] = @Original_name) AND ([soluong] = @Original_soluong));\r\nSEL" +
                "ECT id, name, soluong FROM Kho WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, soluong FROM dbo.Kho";
        ...
        public virtual int Fill(QuanLyQuanCafeDataSet2.KhoDataTable dataTable) {
        ...
        public virtual QuanLyQuanCafeDataSet2.KhoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyQuanCafeDataSet2.KhoDataTable dataTable = new QuanLyQuanCafeDataSet2.KhoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyQuanCafeDataSet2.KhoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, double Original_soluong) {
        ...
        public virtual int Insert(string name, double soluong) {
            if ((name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((double)(soluong));
        ...
        public virtual int Update(string name, double soluong, int Original_id, string Original_name, double Original_soluong, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((double)(soluong));
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((double)(Original_soluong));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, double soluong, int Original_id, string Original_name, double Original_soluong) {
            return this.Update(name, soluong, Original_id, Original_name, Original_soluong, Original_id);
        }
    }
