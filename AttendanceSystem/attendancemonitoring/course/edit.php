                ...
                <div class="features">
                           ...
                           <form class="form-horizontal span6 wow fadeInDown" action="controller.php?action=edit" method="POST"> 
                                   <input class="form-control input-sm" id="COURSE_ID" name="COURSE_ID" placeholder=
                                      "Account Id" type="Hidden" value="<?php echo $singlecourse->TeamID; ?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                              
                              <div class="form-group">
                              <div class="col-md-8">
                                <label class="col-md-4 control-label" for=
                                "COURSE_NAME">Team:</label>

                                <div class="col-md-8">
                                  
                                   <input class="form-control input-sm" id="COURSE_NAME" name="COURSE_NAME" placeholder=
                                      "Team" type="text" value="<?php echo $singlecourse->TeamCode; ?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                                </div>
                              </div>
                            </div> 
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="COURSE_DESC" name="COURSE_DESC" placeholder=
                                      "Team Description" type="text" value="<?php echo $singlecourse->Description; ?>" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                                </div>
                              </div>
                            </div>
