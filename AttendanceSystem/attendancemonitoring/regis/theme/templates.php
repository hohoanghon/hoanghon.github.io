...
<ul>
   <li class="<?php echo (currentpage_public() == 'index.php') ? "active" : false;?>"><a href='<?php echo web_root; ?>regis/index.php'><i class="fa fa-home"></i> Home</a></li>
  <!--  <li class="<?php echo (currentpage_public() == 'student') ? "active" : false;?>"><a href='<?php echo web_root; ?>student/'><i class="fa fa-users"></i> Employees</a></li> -->
   <li class="<?php echo (currentpage_public() == 'attendance') ? "active" : false;?>"><a href='<?php echo web_root; ?>regis/attendance/'><i class="fa fa-clock-o"></i> Attendance</a></li>
