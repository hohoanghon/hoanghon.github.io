...
<ul>
   ...
   <li class="<?php echo (currentpage_public() == 'student') ? "active" : false;?>"><a href='<?php echo web_root; ?>student/'><i class="fa fa-users"></i> Employees</a></li>
   ...
   <li class="<?php echo (currentpage_public() == 'event') ? "active" : false;?>"><a href='<?php echo web_root; ?>event/'><i class="fa fa-clock-o"></i> Events</a></li>
   <li  class="<?php echo (currentpage_public() == 'course') ? "active" : false;?>"><a href='<?php echo web_root; ?>course/'><i class="fa fa-graduation-cap"></i> Teams</a></li>
...
<div class="container"  style="min-height:500px;">
    ...
    <footer id="footer" class="midnight-blue" style="background-color: #47c9af;border-top: 1px solid #47c9ad">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2021 <a target="_blank" href="<?php echo web_root; ?>" title="Free Twitter Bootstrap WordPress Themes and HTML templates">Attendance Monitoring System</a>. All Rights Reserved.
                </div> 
