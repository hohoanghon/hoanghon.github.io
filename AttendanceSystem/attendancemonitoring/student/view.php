<?php  
    ...
    $course = New Course();
    $resCourse = $course->single_course($res->TeamID);
                ...
                <div class="features">
                      <div class="col-sm-3 wow fadeInDown">
                              ...
                              <ul class="list-group">
                                  ...
                                  <li class="list-group-item text-right"><span class="pull-left"><strong>Team</strong></span> <?php echo $resCourse->TeamCode; ?> </li>
